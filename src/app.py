...
activities = {
    ...
    "Swim Club": {
        "description": "Swim practice, drills, and occasional competitions",
    ...
    "Drama Club": {
        "description": "Acting exercises, scene study, and theater production",
    ...
    "Science Club": {
        "description": "Investigate experiments, research, and science fair projects",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["jackson@mergington.edu", "sofia@mergington.edu"]
    }
}
